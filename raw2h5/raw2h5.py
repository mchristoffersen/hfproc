...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Program for conversion of raw radar sounding files to HDF5"
    )
    parser.add_argument(
        "type", help="File type of raw data file(s)", choices=["rec", "tdms", "lowres"]
    )
